...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Static palette shades (no CSS variable — used for one-off utilities)
        primary: {
          50: '#eff6ff',
          100: '#dbeafe',
          500: '#3b82f6',
        ...
        // Semantic surface tokens — resolve via CSS variables so dark mode works
        surface: {
        ...
        // Status colors — used exclusively for status indication
        status: {
